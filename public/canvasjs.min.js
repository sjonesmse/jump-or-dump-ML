...
;(function() {
  ...
  function Oa(k, p, D) {
    if (r && bb) {
      ...
      k.height = D * W
      Ua !== Pa &&
        ((k.style.width = p + 'px'), (k.style.height = D + 'px'), u.scale(W, W))
  ...
  V.prototype.updateOption = function(k) {
    ...
    this.theme && u(E) && u(H)
      ...
      : this.parent &&
        (this.parent.themeOptions && this.parent.themeOptions[E]) &&
        (null === H
  ...
  Na.Chart = (function() {
    ...
    p.prototype._updateOptions = function() {
      ...
      this._menuButton
        ? this.exportEnabled ? Qa(this._menuButton) : va(this._menuButton)
        : this.exportEnabled &&
          r &&
          ((d = !1),
            ...
            null === c.color
              ? 1 < this.options.data.length
                ? ((c._colorSet = [
                  ...
                  (c.color = this._selectedColorSet[
                    c.index % this._selectedColorSet.length
                  ]))
                : (c._colorSet =
                    'line' === c.type ||
              ...
              : 'xySwapped' === e
                ...
                : 'none' === e
                  ? 'normal' === this.plotInfo.axisPlacement
                    ...
                    : 'xySwapped' === this.plotInfo.axisPlacement
                      ? (g =
                          'You cannot combine "' + c.type + '" with bar chart')
                      : null === this.plotInfo.axisPlacement &&
                                                    ...
                                                    : 'ohlc' === l.type
                                                      ...
                                                      : 'rangeColumn' === l.type
                                                        ...
                                                        : 'error' === l.type
                                                          ...
                                                          : 'rangeBar' ===
                                                            l.type
                                                            ? (w = this.renderRangeBar(
                                                                l
                                                              ))
                                                            : 'rangeArea' ===
                                                              l.type
                                                              ? (w = this.renderRangeArea(
                                                                  l
                                                                ))
                                                              : 'rangeSplineArea' ===
                                                                l.type
                                                                ...
                                                                : 'waterfall' ===
                                                                  l.type
                                                                  ? (w = this.renderWaterfall(
                                                                      l
                                                                    ))
                                                                  : 'boxAndWhisker' ===
                                                                      l.type &&
                                                                    (w = this.renderBoxAndWhisker(
                                                                      l
                                                                    ))
            ...
            if (c < p && !f) null !== q.dataPoints[n].y && (k = c)
              ...
              null === q.dataPoints[n].y
                ...
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e),
                  0 <= e
                    ? m[c] ? (m[c] += e) : ((m[c] = e), (w = Math.min(e, w)))
                    : l[c] ? (l[c] += e) : ((l[c] = e), (h = Math.max(e, h))))
            }
          }
          a.axisY.scaleBreaks &&
                ...
                for (w = 0; w < k.dataPoints.length; w++)
                  if (
                    ...
                    var r =
                      (n + 1 - m) *
                      Math.max(
                        parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) ||
                          10,
                        10
                      ) /
                      100
      ...
      for (var e = 0; e < c.length; e++)
        if ((u(b[c[e]]) && (b[c[e]] = []), 'axisY' === c[e]))
          for (var g = 0; g < this.axisY.length; g++)
            b[c[e]].push({
              viewportMinimum: this[c[e]][g].sessionVariables
                .newViewportMinimum,
    ...
    p.prototype.renderLine = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = [], m, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var B = h._colorSet,
            k = (B = h.lineColor = h.options.lineColor
              ? h.options.lineColor
              : B[0])
          b.strokeStyle = B
          var p = !0,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        return {
          ...
          animationBase:
            h < a.axisY.bounds.y1
              ? a.axisY.bounds.y1
              : h > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : h
        }
      }
    }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        return {
          ...
          animationBase:
            n < a.axisY.bounds.y1
              ? a.axisY.bounds.y1
              : n > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : n
        }
      }
    }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        return {
          ...
          animationBase:
            h < a.axisY.bounds.x1
              ? a.axisY.bounds.x1
              : h > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : h
        }
      }
    }
              ...
              if (
                ...
                var y = (l - k / 2) << 0,
                  ...
                  T = x[m].whiskerColor
                    ? x[m].whiskerColor
                    : x[m].color
                      ? C.whiskerColor ? C.whiskerColor : x[m].color
                      : C.whiskerColor ? C.whiskerColor : e,
                  Y =
                  ...
                  da = u(x[m].whiskerLength)
                    ? u(C.options.whiskerLength) ? k : C.whiskerLength
                    : x[m].whiskerLength,
                  da =
                    'number' === typeof da
                      ? 0 >= da ? 0 : da >= k ? k : da
                  ...
                  oa = x[m].stemColor
                    ? x[m].stemColor
                    : x[m].color
                      ? C.stemColor ? C.stemColor : x[m].color
                      : C.stemColor ? C.stemColor : e,
                  la =
                  ...
                  E = x[m].lineColor
                    ? x[m].lineColor
                    : x[m].color
                      ? C.lineColor ? C.lineColor : x[m].color
                      : C.lineColor ? C.lineColor : e,
                  H =
            ...
            for (var aa = z._colorSet, l = 0; l < y.length; l++) {
              var e = (z.lineColor = z.options.color ? z.options.color : aa[0]),
                T = {
                  color: y[l].whiskerColor
                    ? y[l].whiskerColor
                    : y[l].color
                      ? z.whiskerColor ? z.whiskerColor : y[l].color
                      : z.whiskerColor ? z.whiskerColor : e,
                  ...
                  length: u(y[l].whiskerLength)
                    ? u(z.options.whiskerLength) ? t : z.options.whiskerLength
                    : y[l].whiskerLength,
                  trimLength: u(y[l].whiskerLength)
                    ? u(z.options.whiskerLength) ? 50 : 0
                    : 0
                }
              T.length =
                'number' === typeof T.length
                  ? 0 >= T.length ? 0 : T.length >= t ? t : T.length
              ...
              T.thickness =
                'number' === typeof T.thickness
                  ? 0 > T.thickness ? 0 : Math.round(T.thickness)
                  : 2
              var Y = {
                color: y[l].stemColor
                  ? y[l].stemColor
                  : y[l].color
                    ? z.stemColor ? z.stemColor : y[l].color
                    : z.stemColor ? z.stemColor : e,
              ...
              Y.thickness =
                'number' === typeof Y.thickness
                  ? 0 > Y.thickness ? 0 : Math.round(Y.thickness)
                  : 2
          ...
          if (0 < v.length)
            for (
              ...
              if (
                ...
                var T = v[m].color
                  ? v[m].color
                  : 0 < v[m].y ? u.risingColor : u.fallingColor
                ...
                b.strokeStyle = v[m].lineColor
                  ? v[m].lineColor
                  : u.options.lineColor ? u.options.lineColor : '#9e9e9e'
                b.lineWidth = t
          ...
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
            ...
            m.indexLabelLineColor = g.indexLabelLineColor
              ...
              : h.options.indexLabelLineColor
                ? h.options.indexLabelLineColor
                : g.color ? g.color : h._colorSet[d % h._colorSet.length]
            ...
            m.indexLabelMaxWidth = g.indexLabelMaxWidth
              ...
              : h.indexLabelMaxWidth ? h.indexLabelMaxWidth : 0.33 * n.width
            m.indexLabelWrap =
            ...
            m.startAngle =
              0 === d
                ? h.startAngle ? h.startAngle / 180 * Math.PI : 0
                : f[d - 1].endAngle
        ...
        if (t && C) {
          ...
          for (var y = 0, A = C.length - 1; y < C.length || 0 <= A; y++, A--) {
            ...
            'inside' === t.indexLabelPlacement &&
              ((p[y] =
                y !== fa
                  ? t.reversed ? P[y].x2 - P[y].x1 : P[y].x3 - P[y].x4
                  : P[y].x3 - P[y].x6),
              20 > p[y] &&
                ((p[y] =
                  y !== fa
                    ? t.reversed ? P[y].x3 - P[y].x4 : P[y].x2 - P[y].x1
                    : P[y].x2 - P[y].x1),
                (p[y] /= 2)))
            s = b.indexLabelMaxWidth
              ? b.indexLabelMaxWidth
              : t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : p[y]
            if (s > p[y] || 0 > s) s = p[y]
        ...
        for (
          var g,
            ...
            l = t.options.indexLabelMaxWidth
              ? t.indexLabelMaxWidth > l ? l : t.indexLabelMaxWidth
              : l,
            h = J.length - 1;
          0 <= h;
          h--
          ...
          for (var d = 0; d < P.length; d++)
            0 == J[d].textBlock.text.length
              ...
              : ((a = P[d]),
                ...
                (b = t.reversed
                  ? 'undefined' !== typeof a.x5
                    ? c > Da ? f(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1
                    : (a.x2 + a.x3) / 2 + 1
                  : 'undefined' !== typeof a.x5
                    ? c < Da ? f(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1
                    : (a.x2 + a.x3) / 2 + 1),
                (J[d].textBlock.x = b + S),
        ...
        function b() {
          ...
          for (var l, m = 1; m < h; m++) {
            ...
            for (var s = J.length - 1; 0 <= s; s--)
              !J[s].isDirty &&
                (J[s].textBlock.y < e && J[s].textBlock.y + J[s].height > e) &&
                ((l = n(s)),
                !(l >= J.length - 1) &&
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
        ...
        if ('color' === a)
          return 'waterfall' === b.type
            ? d.color ? d.color : 0 < d.y ? b.risingColor : b.fallingColor
            : 'error' === b.type
              ? b.color ? b.color : b._colorSet[h % b._colorSet.length]
              : d.color
                ? d.color
                : b.color ? b.color : b._colorSet[c % b._colorSet.length]
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
              ...
              p = (q.legendMarkerColor = q.legendMarkerColor
                ...
                : q.markerColor
                  ? q.markerColor
                  : 'error' === q.type
                    ? u(q.whiskerColor) ? q._colorSet[0] : q.whiskerColor
                    : q._colorSet[0]),
              r =
                q.markerSize ||
                ('line' !== q.type &&
              ...
              var x = q.dataPoints[z],
                ...
                p = x.legendMarkerColor
                  ...
                  : q.legendMarkerColor
                    ...
                    : x.color
                      ? x.color
                      : q.color ? q.color : q._colorSet[z % q._colorSet.length],
          ...
          if (n) {
            switch (this.type) {
              ...
              case 'doughnut':
                u = n.center
                r =
                  'doughnut' === this.type ? n.percentInnerRadius * n.radius : 0
    ...
    F.prototype.getMarkerProperties = function(a, d, b, c) {
      ...
      return {
        ...
        borderColor: e[a].markerBorderColor
          ...
          : this.markerBorderColor ? this.markerBorderColor : null,
        borderThickness: e[a].markerBorderThickness
          ? e[a].markerBorderThickness
          : this.markerBorderThickness ? this.markerBorderThickness : null
      }
    }
    qa(z, V)
        ...
        a = new ka(this.ctx, {
          ...
          fontSize:
            'outside' === g.labelPlacement
              ? g.options.labelFontSize ? g.labelFontSize : this.labelFontSize
              : g.labelFontSize,
          fontFamily:
            'outside' === g.labelPlacement
          ...
          fontStyle:
            'outside' === g.labelPlacement
              ? g.options.labelFontStyle ? g.labelFontStyle : this.fontWeight
              : g.labelFontStyle,
          textBaseline: 'middle'
        })
        ...
        for (b = 0; b < this._stripLineLabels.length; b++)
          'outside' === this._stripLineLabels[b].stripLine.labelPlacement &&
            (this._stripLineLabels[b].stripLine.value >= this.viewportMinimum &&
              this._stripLineLabels[b].stripLine.value <=
                this.viewportMaximum) &&
          ...
          if (a && 0 < a.length)
            for (f = 0; f < a.length; f++)
              a[f] &&
                ...
                !a[f] ||
                  (!a[f].labelAutoFit || u(A) || u(E) || p.isNavigator) ||
                  ((l = 0),
                  0 < a[f].labelAngle
                    ? E + t > k &&
                ...
                b[f].labelAutoFit &&
                  ...
                  (0 < !a.length &&
                    (m =
                      0 > b[f].labelAngle
                        ? Math.max(m, C)
                        : 0 === b[f].labelAngle ? Math.max(m, C / 2) : m),
                  0 < !d.length &&
                    (k =
                      0 < b[f].labelAngle
                        ? k - x / 2
                        : 0 === b[f].labelAngle ? k - x / 2 : k)),
                ...
                c[f] &&
                  ...
                  (0 < !a.length &&
                    (m =
                      0 < c[f].labelAngle
                        ? Math.max(m, D)
                        : 0 === c[f].labelAngle ? Math.max(m, D / 2) : m),
                  0 < !d.length && (k -= y / 2)),
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : g.y1 < Math.max(K, 10) ? Math.max(K, 10) : g.y1
                    )
                  : g.y1 < Math.max(K, 10) ? Math.max(K, 10) : g.y1
                ...
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    ...
                    ((k =
                      0 > b[K].labelAngle
                        ? Math.max(k, C)
                        : 0 === b[K].labelAngle ? Math.max(k, C / 2) : k),
                    (m =
                      0 > b[K].labelAngle || 0 === b[K].labelAngle ? k - U : m))
              if (c && 0 < c.length)
                  ...
                  b[K] &&
                    ...
                    ((k =
                      0 > b[K].labelAngle
                        ...
                        : 0 === b[K].labelAngle ? Math.max(k, C / 2) : k),
                    (m =
                      0 > b[K].labelAngle || 0 === b[K].labelAngle ? k - V : m))
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] &&
                    c[K].labelAutoFit &&
    ...
    z.prototype.calculateAxisParameters = function() {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters()
        ...
        var a =
            'axisX' === this.type
              ? 'xySwapped' === this.chart.plotInfo.axisPlacement ? 62 : 70
              : 'xySwapped' === this.chart.plotInfo.axisPlacement ? 50 : 40,
          c = 4
        ...
        if ('axisX' === this.type) {
          ...
          Infinity !== this.dataInfo.minDiff
            ...
            : 1 < g - e ? (m = 0.5 * Math.abs(g - e)) : ((m = 1), b && (d = !0))
        } else
          'axisY' === this.type &&
            ((e =
              null !== this.viewportMinimum
                    ...
                    : 0 === g - e
                      ...
                      : e > g
                        ? ((c = Math.min(
                            0.01 *
                              Math.abs(
                                this.getApparentDifference(g, e, null, !0)
                              ),
                            5
                          )),
                          0 <= g ? (e = g - c) : (g = isFinite(e) ? e + c : 0))
                        : ((c = Math.min(
                            0.01 *
                              Math.abs(
                                this.getApparentDifference(e, g, null, !0)
                              ),
                            0.05
                          )),
                          0 !== g && (g += c),
    ...
    z.getNiceNumber = function(a, d) {
      var b = Math.floor(Math.log(a) / Math.LN10),
        c = a / Math.pow(10, b),
        c = d
          ? 1.5 > c ? 1 : 3 > c ? 2 : 7 > c ? 5 : 10
          : 1 >= c ? 1 : 2 >= c ? 2 : 5 >= c ? 5 : 10
      return -20 > b
        ? Number(c * Math.pow(10, b))
        : Number((c * Math.pow(10, b)).toFixed(20))
    }
    ...
    $.prototype._updateToolTip = function(a, d, b) {
      ...
      if (!this.chart.disableToolTip) {
                  ...
                  'column' === e.type || 'bar' === e.type
                    ...
                    : 'bubble' === e.type
                      ? ((b =
                        ...
                        h.dataPoint.y >=
                          h.dataSeries.axisY.viewportMinimum - b &&
                          h.dataPoint.y <=
        ...
        if (0 < g.length && (this.highlightObjects(g), this.enabled))
          if (
            ((b = ''), (b = this.getToolTipInnerHTML({entries: g})), null !== b)
          ) {
                          ...
                          : 'boxAndWhisker' === c.type
                            ? (d.save(),
                              ...
                              0 < e.whiskerThickness &&
                                (d.beginPath(),
                                d.moveTo(
                                  Math.floor(e.x3 - e.whiskerLength / 2),
                                  e.y4
                                ),
                                d.lineTo(
                                  Math.ceil(e.x3 + e.whiskerLength / 2),
                                  e.y4
                                ),
                                d.stroke(),
                                d.beginPath(),
      ...
      'number' == typeof l.size
        ...
        : -1 != l.size.indexOf('px')
          ...
          : -1 != l.size.indexOf('em')
            ...
            : -1 != l.size.indexOf('%')
              ? (h.size = p / 100 * m)
              : -1 != l.size.indexOf('pt') ? (h.size = m / 0.75) : (h.size = p)
      h.size *= 0.981
      p =
        h.style +
        ' ' +
